...
public class ParkingPlaceTest {
    ...
    public void  init(){
        ...
        parking.put(new ParkingPlace(TypeParking.HANDICAP_TYPE,1,0),new Boolean(true));
        parking.put(new ParkingPlace(TypeParking.HANDICAP_TYPE,3,0),new Boolean(true));
        parking.put(new ParkingPlace(TypeParking.STANDARD_TYPE,3,0),new Boolean(true));


        //Parking space is NOT AVAILABLE if the value es false, this is Occupied
        parking.put(new ParkingPlace(TypeParking.STANDARD_TYPE,2,5),new Boolean(false));
        parking.put(new ParkingPlace(TypeParking.HANDICAP_TYPE,4,2),new Boolean(false));
        parking.put(new ParkingPlace(TypeParking.HANDICAP_TYPE,5,3),new Boolean(false));
        parking.put(new ParkingPlace(TypeParking.HANDICAP_TYPE,6,.5),new Boolean(false));
    }
